...
class Splash:
    def __init__(self, frame, window):
        ...
        big_font = pygame.font.Font(uri_from_path("../data/media/fonts/AmaticSC-Bold.ttf"), int(1100 * coefficient))
        fan = big_font.render("FAN", 1, "white")
        x, y = frame.get_width() * 0.5 - fan.get_width() * 0.5, frame.get_height() * 0.5 - fan.get_height() * 0.5
        frame.blit(fan, (x, y))
        small_font = pygame.font.Font(uri_from_path("../data/media/fonts/AmaticSC-Bold.ttf"), int(120 * coefficient))
